...
#create_clock -period 6000.000 -name clk -waveform {0.000 3000.000} -add [get_ports clk]
...
set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33} [get_ports {enable}];
...
##Pmod Header JA
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { spill_reset   }];
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { Beam_counter1 }];
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { Out_test      }]; #IO_L4N_T0_15 Sch=ja[3]
